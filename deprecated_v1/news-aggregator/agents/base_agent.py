        ...
        try:
            ...
            if conversation_history:
                ...
                if hasattr(self, '_build_custom_prompt'):
                    ...
                    if search_params:
                        from utils.prompt_utils import inject_runtime_search_context
                    ...
                    from utils.prompt_utils import build_prompt, inject_runtime_search_context
            ...
            if isinstance(result_data, str):
                ...
                try:
                    from utils.markdown_parser import parse_markdown_response
