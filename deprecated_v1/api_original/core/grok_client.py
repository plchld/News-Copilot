...
# from ..models import GrokModelConfig, GrokChatResponse, GrokCitation, GrokSearchResult, GrokError # This line is unused
from api.utils.search_params_builder import build_search_params
import json
...
class GrokClient:
    ...
    def __init__(self):
        ...
        self.async_client = AsyncOpenAI(api_key=config.XAI_API_KEY, base_url="https://api.x.ai/v1")
        self.model = "grok-3"
